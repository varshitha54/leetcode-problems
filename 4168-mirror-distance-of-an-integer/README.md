...
<p>Define its <strong>mirror distance</strong> as: <code>abs(n - reverse(n))</code>âââââââ where <code>reverse(n)</code> is the integer formed by reversing the digits of <code>n</code>.</p>

<p>Return an integer denoting the mirror distance of <code>n</code>âââââââ.</p>
